...
function getOptimalModelParameters(options: GenerationOptions = {}) {
  // Base parameters
  let temperature = 0.2;
  let topP = 0.9;
...
export async function generateWorkout(promptData: { prompt: string; variant: any }, options: GenerationOptions = {}) {
  try {
